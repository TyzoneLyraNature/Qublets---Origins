...
INIT_TIME_PERIOD = 30 # miliseconds entre frames
INIT_TIME_MODULO = 1 

IMAGEPATH_BACKGROUND = "Images/background_500_500.jpg"
...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		self.MainWindow.resize(WINDOW_WIDTH + 45, WINDOW_HEIGHT + 83)
		...
		self.spinBoxE1.setGeometry(QtCore.QRect(GAME_AREA_WIDTH + 100, 100, 51, 27))
		...
		self.spinBoxE2.setGeometry(QtCore.QRect(GAME_AREA_WIDTH + 280, 100, 51, 27))
		...
		self.SpinBoxTimePeriod.setGeometry(QtCore.QRect(GAME_AREA_WIDTH + 150, 320, 91, 27))
		...
		self.spinBoxModulo.setGeometry(QtCore.QRect(GAME_AREA_WIDTH + 150, 360, 100, 27))
